...
const Contact = () => {
  return (
    <>
      <Helmet>
        <title>Contact Us | Furnix Support</title>
        <meta
          name="description"
          content="Get in touch with Furnix for product inquiries, support, and feedback. We're here to help with all your furniture needs."
        />
      </Helmet>
      <section className="py-8 lg:py-28 px-5 max-w-5xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div>
            <h1 className="text-3xl lg:text-5xl font-normal mb-3">
              Contact Us
            </h1>
            <h2 className="text-xl font-light mb-4">We are Here to Help</h2>
            <p className="text-gray-700 text-base mb-4">
              Have questions about products, orders, or returns? Our team is
              ready to assist you.
            </p>
